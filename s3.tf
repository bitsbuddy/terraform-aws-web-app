...
resource "aws_s3_bucket" "new_bucket_3" {
  # The name of the bucket.
  bucket = "new-bucket-3-name"
...
resource "aws_s3_bucket_policy" "new_bucket_3_policy" {
  bucket = aws_s3_bucket.new_bucket_3.id
...
resource "aws_s3_bucket" "new_bucket_4" {
  # The name of the bucket.
  bucket = "new-bucket-4-name"
...
resource "aws_s3_bucket_policy" "new_bucket_4_policy" {
  bucket = aws_s3_bucket.new_bucket_4.id
...
resource "aws_s3_bucket_object" "new_bucket_4_object" {
  for_each = fileset(var.dist_dir, "**")
...
resource "aws_s3_bucket" "new_bucket_5" {
  # The name of the bucket.
  bucket = "new-bucket-5-name"
...
resource "aws_s3_bucket_policy" "new_bucket_5_policy" {
  bucket = aws_s3_bucket.new_bucket_5.id
...
resource "aws_s3_bucket_object" "new_bucket_5_object" {
  for_each = fileset(var.dist_dir, "**")
